...
int main(int argc, char *argv[])
{
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        string pathCam0 = pathSeq + "/Camera/Camera0";
        string pathImu = pathSeq + "/joinedRawIMU.csv";
        ...
        cout << "nImages = " << static_cast<int16_t>(nImages[seq]) << endl;
        cout << "nImu = " << static_cast<int16_t>(nImu[seq]) << endl;
    ...
    cout << "Finished loading sequences " << endl;
    cout << static_cast<int16_t >(first_imu[seq]) << endl;
    ...
    cout << "Initializing ORB Slam system " << endl;
