...
public:
    ...
    int ratioTest2(std::vector<std::vector<cv::DMatch> > &matches);
    ...
    void calcdesriptorsperframe(const cv::Mat& frame,std::vector<cv::KeyPoint>& keypoints_frame,cv::Mat& descriptors_frame);
    void fastRobustMatch2( std::vector<cv::DMatch>& good_matches,
                                     cv::Mat& descriptors_frame,
                                     const cv::Mat& descriptors_model);
    void fastRobustMatch3( std::vector<cv::DMatch>& good_matches,
                           cv::Mat& descriptors_frame,
                           const cv::Mat& descriptors_model);
    void fastRobustMatchmap( std::vector<cv::DMatch>& good_matches,
                                     std::vector<cv::KeyPoint>& keypoints_frame,
