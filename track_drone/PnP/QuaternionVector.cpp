...
namespace PnP {
    QuaternionVector::QuaternionVector(const Eigen::Vector4d &quaternions) : quaternions(quaternions) {
        q1 = quaternions.x();
        q2 = quaternions.y();
        q3 = quaternions.z();
        q4 = quaternions.w();
    ...
    Eigen::Matrix4d QuaternionVector::obj_hess(const ColVector<Y_SIZE>& b) const {
        ...
        result_hess << q1q1_hess, q1q2_hess, q1q3_hess, q1q4_hess,
                       q1q2_hess, q2q2_hess, q2q3_hess, q2q4_hess,
                       q1q3_hess, q2q3_hess, q3q3_hess, q3q4_hess,
                       q1q4_hess, q2q4_hess, q3q4_hess, q4q4_hess;
