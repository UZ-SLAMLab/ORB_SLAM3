...
namespace PnP {
    PnpProblemSolver::PnpProblemSolver(const SparseRowMatrix &A_rows,
                                       const SparseColMatrix &A_cols,
            ...
            : A_rows(A_rows),
              ...
              zero_mat_15_15(std::move(zero_mat_15_15)),
              init_y(std::move(init_y)),
    ...
    std::shared_ptr<PnpProblemSolver> PnpProblemSolver::init() {
        ...
        init_y_vec << 1.81708374227065E-07, -2.71468522392971E-10, -1.49378319259558E-10, -2.77091740805445E-11,
                      0.249631001517346, 4.96940105201532E-05, -0.000129984428061, 5.97892049448515E-05, 0.249893826536401,
                      -0.000282031359397, -0.000299838600691, 0.250010662193677, -0.000119648361021, 0.250464509752576,
                      1.81036335999704E-07, -2.7244555135617E-10, -1.44912520866555E-10, -3.09767807222993E-11,
                      2.26443899887141E-10, -3.1024811831443E-12, 3.18281863003413E-13, 2.14461800733467E-10,
                      -1.33638362717957E-12, 2.31132526688904E-10, 7.61682308171569E-13, -8.51485831453974E-13,
                      7.23456344454997E-13, 5.18662287311713E-13, -9.181167075483E-14, -3.03315632232526E-13,
                      -3.06071262491456E-12, 8.84104200363805E-13, -5.53599936640479E-13, 1.66004609693395E-12,
                      0.12485918729074, 1.24357475655128E-05, -1.06930867828931E-06, -3.41617427196685E-05,
                      0.04161036487279, 1.32703449912371E-05, -7.18816799089538E-06, 0.041597999991592,
                      -3.58128226124226E-06, 0.041563449362224, 5.72613189555295E-05, -1.80142323379959E-05,
                      3.18277376965713E-05, 6.54613708082515E-05, -1.75831016069252E-05, -8.54644268091407E-05,
                      -0.000152813856463, 6.69489404481575E-05, 4.19129694179984E-05, -4.82573048020879E-06,
                      0.124762538478383, -3.70010098743364E-05, 2.6077418953879E-05, 0.041753219462236, -0.000129437659595,
                      0.041767703722993, -0.000320047212861, 0.000129331848335, 6.17465183469158E-05, -0.000448059699989,
                      0.125204467737999, -0.000108969941535, 0.04145497500185, 0.00012234052237, 0.125678381665509;
        ...
        A_mat_cols.setFromTriplets(A_mat_triplet_list.begin(), A_mat_triplet_list.end());

        SparseRowMatrix A_mat_rows(A_ROWS, Y_SIZE);
        A_mat_rows.setFromTriplets(A_mat_triplet_list.begin(), A_mat_triplet_list.end());
        ...
        return std::make_shared<PnpProblemSolver>(A_mat_rows, A_mat_cols, c_vec, zero_sub_A_rows, zero_sub_A_cols, zero_mat_15_15, init_y_vec, dual_var);
    }
}
