...
void Viewer::CreatePanel()
{
    ...
    menuFollowCamera = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Follow Camera",true,true));
    menuCamView = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Camera View",false,false));
    menuTopView = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Top View",false,false));
    // pangolin::Var<bool> menuSideView("menu.Side View",false,false);
    menuShowPoints = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Show Points",true,true));
    menuShowKeyFrames = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Show KeyFrames",true,true));
    menuShowGraph = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Show Graph",false,true));
    menuShowInertialGraph = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Show Inertial Graph",true,true));
    menuLocalizationMode = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Localization Mode",false,true));
    menuReset = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Reset",false,false));
    menuStepByStep = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Step By Step",false,true));  // false, true
    menuStep = std::unique_ptr<pangolin::Var<bool>>(new pangolin::Var<bool>("menu.Step",false,false));

    // Define Camera Render Object (for view / scene browsing)
    s_cam = std::unique_ptr<pangolin::OpenGlRenderState>(new pangolin::OpenGlRenderState(
