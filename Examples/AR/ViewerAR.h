...
private:
    ...
    pangolin::OpenGlMatrix _projMatrix; 
    pangolin::Viewport _viewport;

    bool bLocalizationMode = false;
    pangolin::OpenGlRenderState s_cam;
    pangolin::OpenGlMatrixSpec projectionMatrixRDF;
    pangolin::GlTexture *mvImageTexture;
    pangolin::View d_image;

    static vector<Plane*> vpPlane;

    std::unique_ptr<pangolin::Var<bool>> menu_detectplane;
    ...
    std::unique_ptr<pangolin::Var<bool>> menu_drawcube;
    ...
    std::unique_ptr<pangolin::Var<bool>> menu_drawpoints;
