...
{  
    if(argc < 5)
    {
        ...
        cerr << endl << "Example: ./Examples/Monocular/stereo_mimir /home/olaya/dev/ORB_SLAM3/Vocabulary/ORBvoc.txt /home/olaya/dev/ORB_SLAM3/Examples/Stereo/MIMIR.yaml /home/olaya/Datasets/MIMIR/SeaFloor/track0 /home/olaya/Datasets/MIMIR/SeaFloor/track0/auv0/ORB_timestamps.txt /home/olaya/Datasets/MIMIR/SeaFloor/track0 /home/olaya/Datasets/MIMIR/SeaFloor/track0/auv0/ORB_timestamps.txt seafloor_track1.txt" << endl;
        return 1;
    }
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        string pathCam1 = pathSeq + "/auv0/rgb/cam1/data";
