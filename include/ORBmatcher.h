...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        int SearchByBoW(KeyFrame *pKF1, KeyFrame* pKF2, std::vector<MapPoint*> &vpMatches12, std::map<MapPoint*, int> mapPointToDistance, std::map<MapPoint*, KeyFrame*> mapPointToKeyFrame);
